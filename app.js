...
var createNewTaskElement=function(taskString){
    ...
    label.className='menu__label menu__label-complete';

    //Each elements, needs appending
    listItem.className="menu__item"

    checkBox.type="checkbox";
    checkBox.className="menu__input menu__checkbox";
    editInput.type="text";
    editInput.className="section__input menu__input menu__text";

    editButton.innerText="Edit"; //innerText encodes special characters, HTML does not.
    editButton.className="menu__btn btn-edit";

    deleteButton.className="menu__btn btn-delete";
...
var editTask=function(){
    ...
    var label=listItem.querySelector(".menu__label");
...
//select ListItems children
    var checkBox=taskListItem.querySelector(".menu__checkbox");
